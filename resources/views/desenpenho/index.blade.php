                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="client-list">
                            ...
                            <tbody>
                              @forelse ($desenpenhos as $especialidade)
                                        ...
                                        <div class="modal fade"  id="deleteprofissional-{{ $especialidade->id }}">
                                            <div class="modal-dialog modal-md" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{route('desenpenho.destroy', $especialidade->id)}}" method="POST" >
                                                            @csrf
                                                            @method('DELETE')
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <label class="form-label">Código de trabalho</label>
                        <select class="form-control" name="id_trabalho" id="">
                            <option value="">Selecione o código</option>
                            @foreach ($trabalhos as $options)
