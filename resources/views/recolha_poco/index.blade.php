                        ...
                        <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="client-list">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">Poço</th>
                                    <th class="border-bottom-0">User</th>
                                </tr>
                            </thead>
                            <tbody>
                              @forelse ($recolhaPocos as $especialidade)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $especialidade->id_poco}}</td>
                                    <td>{{ $especialidade->id_user}}</td>
                                    <td>
                                        <div class="d-flex">
...
><!-- end app-content-->
 ...
 <div class="modal fade"  id="eventmodal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Novo Poço recolhido</h5>
                <button  class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{route('pocoRecolhidos.store')}} " method="POST" enctype="multipart/form-data" >
                    @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="id_poco" id="">
                            <option value="">Selecione o tipo de poço</option>
                            @foreach ($pocos as $options)
